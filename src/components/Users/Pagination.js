...
// p >= (props.currentPage) && p <= (((props.totalCount - props.currentPage) >= 10) ? (props.currentPage + 10) : (props.totalCount - props.currentPage))
// {pages.filter(p => (props.currentPage <= 10) ? (p >= 1 && p <= 10) : ((p >= 1 && p <= 10) &&  (p >= (props.currentPage) && p <= (((props.totalCount - props.currentPage) >= 10) ? (props.currentPage + 10) : (props.totalCount - props.currentPage)))))}


// (p >= 1 && p <= 4) && (p >= 10 && p <= 15) && (p >= 22 && p <= 29)